...
$lang['required'] 			= "%s (을)를 입력하세요.";
$lang['isset']				= "%s 필드는 반드시 필요한 값입니다.";
$lang['valid_email']		= "%s 주소 양식에 따라 입력하세요.";
...
$lang['min_length']			= "%s (을)를 양식에 맞게 입력해주세요.";
$lang['max_length']			= "%s (을)를 양식에 맞게 입력해주세요.";
$lang['exact_length']		= "%s 의 길이는 정확히 %s 개의 문자여야 합니다.";
...
$lang['numeric']			= "%s (은)는 반드시 숫자만 포함할 수 있습니다.";
